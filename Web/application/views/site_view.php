...
<div class="homecol">
	<a href="<?=site_url('obras/realizadas')?>"><h3 id="orealizadas" <?=(isset($lang_css) ? $lang_css : '')?>>Obras Realizadas</h3></a>
...
<div class="homecol">
	<a href="<?=site_url('obras/em-andamento')?>"><h3 id="orecentes" <?=(isset($lang_css) ? $lang_css : '')?>>Obras Recentes</h3></a>
...
<div class="fonehome">
	<a href="<?= site_url('contato')?>"><h3 id="fhome" <?=(isset($lang_css) ? $lang_css : '')?>>Contato</h3></a>
