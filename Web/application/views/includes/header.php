	...
	<div id="outter-wrap">
        ...
        <div id="wrapper">
        	<div id="top">
                ...
                <div id="menu">
				<a href="<?=site_url()?>"><?=mb_strtoupper(lang('menu_home'),'UTF-8')?></a>
			| <a href="<?=site_url('cetenco')?>"><?=mb_strtoupper(lang('menu_company'),'UTF-8')?></a>
			| <a href="<?=site_url('obras/realizadas')?>"><?=mb_strtoupper(lang('menu_obras_realizadas'),'UTF-8')?></a>
			| <a href="<?=site_url('obras/em-andamento')?>"><?=mb_strtoupper(lang('menu_obras_em_andamento'),'UTF-8')?></a>
			| <a href="<?=site_url('area-restrita')?>"><?=mb_strtoupper(lang('menu_area_restrita'),'UTF-8')?></a>
			| <a href="<?=site_url('contato/trabalhe-conosco')?>"><?=mb_strtoupper(lang('menu_trabalhe_conosco'),'UTF-8')?></a>
			| <a href="<?=site_url('contato')?>"><?=mb_strtoupper(lang('menu_contato'),'UTF-8')?></a></div>
